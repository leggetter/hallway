...
Logger.prototype.trace = function(label, message) {
...
Logger.prototype.anubis = function(req, js) {
  ...
  if (req.query) Object.keys(req.query).forEach(function(key) {
    if (key !== 'access_token') {
...
if( lconfig.logger === undefined || ( lconfig.logger.reap !== false && lconfig.logger.reap !== 'false'  ) ) {
